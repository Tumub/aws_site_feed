...
import factoryBg from "@/assets/factory-telemetry-bg.png";
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-5">
            <h1 className="font-display text-4xl leading-[1.05] tracking-tight uppercase sm:text-5xl md:text-6xl lg:text-7xl">
              ...
              <br />
              <span className="text-primary">Into Production.</span>
            </h1>
            <p className="max-w-xl text-sm text-muted-foreground sm:text-base md:text-lg">
              Embedded expertise that applies the right <strong className="text-accent">Torque</strong> to your Supply Chain and casts a new digital future in our <strong className="text-primary">Foundry</strong>. Not from afar, but from within.
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <Button variant="outline" asChild className="border-accent/60 bg-transparent font-mono text-[0.75rem] uppercase tracking-[0.25em] text-accent hover:bg-accent/10">
              <a href="#power-trio">Our Expertise</a>
            </Button>
          </div>
