...
Generated by TorqueFoundry Application
        ...
        const mailtoLink = `mailto:info@torquefoundryadvisory.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;

        window.location.href = mailtoLink;

        toast.success("SIGNAL TRANSMITTED. OPENING EMAIL CLIENT...");
